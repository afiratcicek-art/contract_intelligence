...
const base =
  "inline-flex items-center justify-center px-6 py-2 text-sm font-semibold tracking-[0.5px] rounded-none transition-all duration-150 select-none";
