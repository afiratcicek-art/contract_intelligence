...
const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  "action.newdeliverable": { tr: "+ Yeni Yükümlülük", en: "+ New Deliverable" },
  ...
  "state.nodeliverables": { tr: "Yükümlülük bulunamadı.", en: "No deliverables found." },
  "state.precompletion": { tr: "Tamamlama Öncesi", en: "Pre-completion" },
  "state.pendingdetail": { tr: "detay bekleniyor", en: "pending detail" },
  // Login
